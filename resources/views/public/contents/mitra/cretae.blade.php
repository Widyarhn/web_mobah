...
<div class="row">
    <div class="col-lg-12 col-md-12 col-md-12">
        <div class="card blog-edit">
            <form id="form" action="{{ route('mitra.store') }}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="position" class="form-control" value="{{ old('username') }}" required>
                    </div>
