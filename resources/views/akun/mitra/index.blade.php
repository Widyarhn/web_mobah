...
<script>
    ...
    function edit(id) {
        submit_method = 'edit';
        var url = "{{ route('kelola-gapoktan.edit', ':user_id') }}";
        ...
        $.get(url, function (response) {
            ...
            var imageName = data.mitra.image;
            if (imageName) {
            ...
            $('#no_hp').val(data.mitra.no_hp);
            $('#alamat').val(data.mitra.alamat);
    ...
    function submit() {
        ...
        if (submit_method === 'create') {
            url = "{{ route('kelola-gapoktan.store') }}";
        } else if (submit_method === 'edit') {
            url = "{{ route('kelola-gapoktan.update', ':user_id') }}";
            url = url.replace(':user_id', id);
